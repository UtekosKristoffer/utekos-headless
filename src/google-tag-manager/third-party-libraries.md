...
If you're using a server-side tag manager and serving `gtm.js` scripts from your
...
Google Analytics automatically tracks pageviews when the browser history state
