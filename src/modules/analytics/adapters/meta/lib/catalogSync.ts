// Path: src/modules/analytics/adapters/meta/lib/catalogSync.ts

import { getAllProductsForMetaSync } from '@/modules/analytics/adapters/meta/lib/getAllProductsForMetaSync'
