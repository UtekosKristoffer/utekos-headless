// Path: src/modules/cart/components/AddToCart/components/QuickViewModal.tsx
'use client'
...
import { QuickViewModalSkeleton } from '@/components/skeletons/QuickViewModalSkeleton'
import type { ShopifyProduct, QuickViewModalProps } from '@types'
