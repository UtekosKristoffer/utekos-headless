...
import { getCartErrorMessage } from '@/lib/errors/getCartErrorMessage'
import type {
  CartActionsResult,
  CartMutationFn,
  CartMutationInput
 ...
 */
export const useCartMutation = <TInput extends CartMutationInput>(
  mutationFn: CartMutationFn<TInput>
) => {
