// Path: src/lib/tracking/pinterest/sendPinterestLeadEvent.ts

import { logToAppLogs } from '@/lib/tracking/log/logToAppLogs'
import type { PinterestLeadEventProps } from '@types'
...
export async function sendPinterestLeadEvent(props: PinterestLeadEventProps) {
