// Path: src/lib/tracking/tiktok/sendTikTokPurchaseEvent.ts
      ...
      data: [
        {
          ...
          user: {
            ...
            ttp: customer.ttp,
            email: customer.email ? hashAdData(customer.email) : undefined,
            phone: customer.phone ? hashAdData(customer.phone) : undefined,
            external_id:
              customer.externalId ? hashAdData(customer.externalId) : undefined,
