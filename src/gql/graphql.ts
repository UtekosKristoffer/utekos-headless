...
import type { shopifyFetcher } from "../qraphql-fetcher";
...
export const useGetProductQuery = <TData = GetProductQuery, TError = unknown>(
  ...
  return useQuery<GetProductQuery, TError, TData>(
    ...
    shopifyFetcher<GetProductQuery, GetProductQueryVariables>(
      GetProductDocument,
      variables
    ),
    options
