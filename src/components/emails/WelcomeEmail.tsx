...
export const WelcomeEmail = ({ email, discountCode = 'VELKOMMEN10' }: WelcomeEmailProps) => {
      ...
      <Body className='bg-gray-100 my-auto mx-auto font-sans'>
        <Container className='border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[600px] bg-white'>
          ...
          <Text className='text-text text-[16px] leading-[24px] text-center'>
            Vi er utrolig glade for at du vil følge oss. Nå er du den første til å få vite om produktnyheter,
          ...
          <Section className='bg-brand-light rounded-lg p-6 my-8 text-center mx-auto'>
            <Text className='text-brand-dark font-medium text-[16px] m-0 mb-2'>
              Som en takk for at du meldte deg på, får du 10% rabatt på ditt første kjøp:
            </Text>
            <Heading
              as='h2'
          ...
          <Section>
            <Row>
              <Column className='align-top pl-4 w-1/2 border-r border-gray-200 pr-4'>
                <Heading as='h3' className='text-[16px] font-bold m-0 mb-2 text-brand-dark'>
                  Inspirasjon
                </Heading>
                <Text className='text-[14px] text-text-muted m-0'>
                  Tips og triks for å skape den perfekte uteplassen, uansett årstid.
                </Text>
              </Column>
              <Column className='align-top pl-4 w-1/2'>
                ...
                <Text className='text-[14px] text-text-muted m-0'>
                  Våre abonnenter får ofte tilgang til salg og nyheter før alle andre.
                </Text>
              </Column>
            </Row>
          </Section>
          ...
          <Section className='text-center'>
            <Text className='text-text-muted text-[12px] leading-[20px]'>
              Du mottar denne e-posten fordi du meldte deg på nyhetsbrevet vårt på Utekos.no.
            </Text>
            <Text className='text-text-muted text-[12px] leading-[20px]'>
              <Link href={`${baseUrl}/privacy-policy`} className='text-text-muted underline'>
                Personvernerklæring
              </Link>
            </Text>
            <Text className='text-text-muted text-[12px] leading-[20px] mt-4'>
              © {new Date().getFullYear()} Utekos AS. Alle rettigheter reservert.
            </Text>
          </Section>
        </Container>
      </Body>
