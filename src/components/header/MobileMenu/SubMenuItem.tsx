...
export function SubMenuItem({ item }: { item: MenuItem }) {
  return (
    ...
    >
      <div className='absolute left-2 top-1/2 h-5 w-[2px] -translate-y-1/2 rounded-full bg-linear-to-b from-very-peri/74 via-ancient-water/50 to-transparent opacity-70' />
