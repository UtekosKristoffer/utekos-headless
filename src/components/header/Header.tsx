...
export default function Header({ menu }: { menu: MenuItem[] }) {
  return (
    <header className='sticky! top-0! z-50 w-full border-b border-cloud-dancer/12 bg-maritime-blue text-cloud-dancer shadow-[0_18px_44px_-34px_color-mix(in_oklab,var(--maritime-darkest)_82%,transparent)]'>
