...
import type { Moment, MomentTheme } from '@/components/frontpage/MomentSection/utils/moments'
...
> = {
  ...
  plum: {
    wrapper:
      'border-white/10 bg-linear-to-br from-chocolate-plum/95 to-chocolate-plum/80 shadow-[0_16px_40px_rgba(0,0,0,0.3)] shadow-[inset_0_1px_1px_rgba(255,255,255,0.08)] backdrop-blur-2xl',
  ...
  overcast: {
    wrapper:
      'border-white/40 bg-linear-to-br from-overcast/95 to-overcast/80 shadow-[0_16px_40px_rgba(0,0,0,0.1)] shadow-[inset_0_1px_1px_rgba(255,255,255,0.8)] backdrop-blur-2xl',
...
export function MomentCard({ moment, index }: { moment: Moment; index: number }) {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'group relative h-full overflow-hidden rounded-3xl p-8 transition-all duration-700 ease-out hover:-translate-y-1.5 hover:shadow-2xl',
