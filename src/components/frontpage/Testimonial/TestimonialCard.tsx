    ...
    >
      <div className='absolute -top-12 left-8 h-12 w-0.5 md:left-10 z-0'>
        <div
          ref={lineRef}
          className={cn(
            'will-animate-scale-y size-full origin-top bg-maritime-darkest transition-transform duration-700 ease-out',
      ...
      <div className='relative flex h-full flex-col overflow-hidden rounded-2xl border border-very-peri/35 bg-maritime-darkest p-8 backdrop-blur-md transition-all duration-500 hover:border-background/25 hover:bg-overcast hover:-translate-y-1 hover:shadow-2xl hover:shadow-very-peri/20'>
        ...
        <Quote className='absolute top-6 right-6 h-16 w-16 rotate-12 text-foreground/25 transition-transform duration-700 group-hover:rotate-0 group-hover:scale-110' />
        ...
        <div className='relative z-10 flex flex-col h-full'>
          ...
          <footer className='mt-auto flex items-center justify-between border-t border-foreground/75 pt-6'>
