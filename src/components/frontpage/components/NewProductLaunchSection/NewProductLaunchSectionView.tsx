      ...
      <div data-launch-stage className='w-full'>
        ...
        >
          ...
          <div className='container mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-3 sm:gap-12 sm:px-6 lg:px-10 xl:grid-cols-[minmax(0,0.94fr)_minmax(0,1.06fr)] xl:gap-12'>
            <div className='gsap-image-col'>
              <ImageColumn />
            </div>

            <div className='gsap-content-col flex w-full flex-col items-start'>
              ...
              <p className='gsap-item mb-4 text-lg font-bold leading-[1.08] tracking-tight text-cloud-dancer sm:text-2xl md:text-3xl xl:text-3xl'>
                Norsk vår er uforutsigbar
              </p>
              <h2 className='gsap-item mb-7 max-w-3xl pb-2 text-[1.7rem] font-bold leading-[0.94] tracking-tight text-cloud-dancer min-[360px]:text-[1.8rem] sm:mb-8 sm:text-[2.5rem] md:text-5xl md:leading-[0.9] xl:max-w-none xl:text-6xl 2xl:text-7xl'>
              ...
              <div className='mb-8 w-full space-y-3 text-overcast sm:space-y-4'>
                {newProductFeatures.map(feature => (
                  <div key={feature.title} className='gsap-feature'>
