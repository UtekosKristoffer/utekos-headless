...
import { MomentCard } from '@/components/frontpage/sections/MomentsSection/components/MomentCard'
import { moments } from '@/components/frontpage/sections/MomentsSection/utils/moments'
