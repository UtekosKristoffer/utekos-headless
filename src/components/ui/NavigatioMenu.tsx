...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root data-slot='navigation-menu' data-viewport={viewport} className={cn('group/navigation-menu relative max-w-max flex-1 items-center justify-center flex', className)} {...props}>
      {children}
