          ...
          <Card className='border-neutral-800 bg-background'>
            <CardContent className='p-12'>
              <blockquote className='mb-6 italic text-foreground/90 text-xl'>
                &quot;Fikk Utekos i 50-årsgave av barna. Helt ærlig den beste gaven jeg har fått på årevis.
                Den brukes hver eneste helg på hytten, uansett vær. Anbefales!&quot;
              </blockquote>
              <div className='flex items-center justify-center gap-4'>
                ...
                <div className='text-left'>
                  ...
                  <p className='text-sm text-muted-foreground'>Fornøyd gavemottaker</p>
                </div>
              </div>
            </CardContent>
          </Card>
