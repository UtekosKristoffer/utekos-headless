      ...
      <div className='flex flex-col'>
        <div className='grow p-8 lg:p-12'>
          <BrandBadge
            ...
            className='mb-6 border border-cloud-dancer/12 px-4 py-2 text-sm leading-4 font-semibold tracking-normal'
          />
          <h1 className='text-4xl font-bold leading-[0.95] tracking-normal text-foreground'>
            Snakk med Utekos
          </h1>
          <p className='mt-4 max-w-xl text-xl leading-text-paragraph tracking-normal text-foreground/90'>
        ...
        <div className='border-y border-cloud-dancer/12'>
          <div className='grid grid-cols-1 sm:grid-cols-2'>
            <div className='border-r border-cloud-dancer/12 p-6 sm:p-8 lg:px-8 lg:py-12'>
              ...
              <p className='mt-2 max-w-prose text-base leading-text-paragraph tracking-normal text-foreground/90'>
        ...
        <div className='p-8 lg:p-12'>
          <blockquote className='text-lg leading-text-paragraph tracking-normal italic text-foreground/90'>
