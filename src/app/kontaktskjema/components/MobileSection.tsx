  ...
  return (
    <div className='lg:hidden'>
      <div className='p-6'>
        ...
        <p className='mt-3 text-base leading-[1.45] tracking-normal text-overcast'>
        ...
        <ul className='mt-6 space-y-6'>
          <li className='flex items-start gap-3'>
            ...
            <div>
              <h3 className='text-sm font-semibold leading-[1.3] tracking-normal text-cloud-dancer'>
      ...
      <div className='border-t border-cloud-dancer/12'>
        <div className='grid grid-cols-2'>
          <div className='border-r border-cloud-dancer/12 p-6'>
            <h4 className='flex items-start gap-1.5 text-xs font-semibold leading-[1.3] tracking-normal text-cloud-dancer'>
