    ...
    >
      <div className='mx-auto max-w-5xl px-6'>
        <div className='gsap-tech-intro mb-16 text-center'>
          ...
          <h2
            id='techdown-heading'
            className='gsap-tech-title mb-6 text-balance font-google-sans text-4xl font-bold leading-[0.9] tracking-[-0.01em] text-maritime-darkest md:text-5xl lg:text-6xl'
          >
          ...
          <div className='flex flex-col items-start gap-8 md:flex-row md:gap-16'>
            ...
            <div className='md:w-2/3'>
              ...
              <div className='border-t border-maritime-darkest pt-6'>
                ...
                <div className='h-1 w-full overflow-hidden rounded-full bg-maritime-darkest/15'>
                  <div
