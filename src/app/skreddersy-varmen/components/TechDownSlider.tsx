...
const content = {
  dry: {
    ...
    icon: <ShieldCheck className='size-6 text-foreground' aria-hidden />
  },
  wet: {
    label: 'Fuktig klima',
    ...
    icon: <Waves className='size-6 text-foreground' aria-hidden />
  }
} as const
...
export function TechDownSlider() {
  ...
  return (
    <section
      ...
      className='w-full border-t border-background bg-foreground py-24 text-maritime-darkest'
    >
      <div className='mx-auto max-w-5xl px-6'>
        <div className='gsap-tech-intro mb-16 text-center'>
          <span className='gsap-tech-eyebrow mb-3 inline-block font-utekos-text-medium leading-4 text-maritime-darkest'>
            Teknologi
          </span>
          <h2
            id='techdown-heading'
          ...
          <p className='gsap-tech-subtitle mx-auto max-w-2xl font-utekos-text-medium leading-text-paragraph text-base md:text-lg text-maritime-darkest'>
            Dra linjen for å se forskjellen på hvordan vanlig dun og Utekos TechDown™ håndterer fuktighet.
          </p>
        </div>

        <div className='mb-5 flex flex-col gap-3 tracking-normal! font-utekos-text rounded-sm border border-background/10 bg-overcast p-4 text-maritme-darkest md:flex-row md:items-center md:justify-between'>
          <label
        ...
        <div className='gsap-tech-slider relative rounded-sm border border-background/10 bg-demitasse p-2 shadow-2xl md:p-4'>
          <div
            ref={sliderImageRef}
            className='relative aspect-4/3w-full cursor-ew-resize select-none overflow-hidden rounded-sm bg-demitasse touch-none md:aspect-21/9'
            style={sliderStyle}
          ...
          >
            ...
            <div className='pointer-events-none absolute right-6 top-6 z-10'>
              <BrandBadge
                backgroundColor='var(--color-demitasse)'
            ...
            <div
              className='absolute bottom-0 top-0 z-40 flex w-1 cursor-ew-resize items-center justify-center bg-demitasse shadow-[0_0_30px_rgba(0,0,0,0.5)]'
          ...
          <div className='flex flex-col items-start gap-8 md:flex-row md:gap-16'>
            <div className='flex flex-col items-start md:w-1/3'>
              <BrandBadge
                backgroundColor='var(--color-demitasse)'
                textColor='var(--color-foreground)'
                className='gsap-tech-status-badge text-foreground mb-4 gap-3 text-xs font-medium leading-none shadow-sm flex items-center'
              >
                <span className='text-base w-full text-left text-balance font-utekos-text-medium leading-4 text-foreground flex items-center gap-2'>
            ...
            <div className='md:w-2/3'>
              <p className='gsap-tech-card-desc mb-8 text-lg font-utekos-text! pb-2 text-maritime-darkest'>
                {currentContent.desc}
              </p>
              ...
              <div className='border-t border-background pt-6'>
                ...
                <p className='mt-2 text-xs italic font-utekos-text leading-text-paragraph text-maritime-darkest'>
