...
export function EmpathySection() {
  ...
  return (
    <section
      ...
      className='relative w-full overflow-hidden bg-white-sand py-16 text-maritime-darkest md:py-24 lg:py-28'
    >
      <div className='mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-6 md:px-12 lg:grid-cols-2 lg:gap-16'>
        <div className='relative'>
          <div className='gsap-empathy-anim relative mb-4 inline-flex items-end overflow-hidden pb-1.5'>
            <span className='gsap-empathy-eyebrow text-sm font-utekos-text-medium leading-4 text-chai-tea'>
              Det du kjenner igjen
            </span>
            <span
              aria-hidden
              className='gsap-empathy-eyebrow-bar absolute left-0 bottom-0 h-px w-full origin-left scale-x-0 bg-chai-tea transition-transform duration-500'
            />
          </div>
          <h2
            id='empathy-heading'
          ...
          <div className='max-w-none text-base leading-text-paragraph text-maritime-darkest'>
            ...
            <div className='relative my-7 py-1.5'>
              <span
                aria-hidden
                // Denne representerer "blåtimen"/den kalde luften som sniker seg inn
                className='gsap-empathy-quote-bar absolute left-0 top-4 bottom-4 w-[3px] origin-top scale-y-0 bg-very-peri transition-transform duration-500'
              />
            ...
            <p className='gsap-empathy-para2 mt-6 max-w-136 text-maritime-darkest'>
              Med Utekos® blir svaret enkelt. Tilpass passform, reguler ventilasjon og veksle mellom ulike
              funksjonelle moduser. Skreddersy varmen for å fortsette opplevelsen av kompromissløs komfort.
              Helt uavbrutt.
              <br />
              <br />
              <span className='font-medium italic text-maritime-darkest'>Juster, form og nyt.</span>
            </p>
          </div>
        ...
        <div className='gsap-empathy-image-wrap relative w-full'>
          <div className='relative aspect-4/5 w-full md:aspect-square'>
            <div className='relative size-full overflow-hidden rounded-sm shadow-2xl shadow-maritime-darkest/20'>
              ...
              <div
                aria-hidden
                className='absolute inset-x-0 bottom-0 h-1/2 bg-linear-to-t from-maritime-darkest/90 via-maritime-darkest/40 to-transparent'
              />
              ...
              <div className='gsap-empathy-image-overlay absolute bottom-5 left-5 right-5 text-cloud-dancer md:bottom-7 md:left-7 md:right-7'>
                <p className='mb-1.5 text-sm font-medium leading-4 tracking-normal text-cloud-dancer/85'>
                  Stemning
                </p>
