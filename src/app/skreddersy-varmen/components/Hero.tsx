    ...
    >
      ...
      <div className='relative z-10 mx-auto flex min-h-[calc(100svh-70px)] w-full max-w-[1400px] flex-col items-start justify-center px-6 pb-16 pt-20 md:px-12 md:pt-24 lg:px-20 xl:min-h-[calc(100svh-86px)]'>
        <div className='max-w-2xl'>
          ...
          <p className='mt-7 max-w-xl font-google-sans text-base leading-[1.45] text-cloud-dancer drop-shadow-md md:text-lg lg:text-xl'>
          ...
          <p
            className='mt-5 flex w-fit max-w-full flex-nowrap items-center whitespace-nowrap font-google-sans text-xs font-medium leading-[1.45] tracking-normal text-cloud-dancer md:text-sm'
            aria-label='På lager, levering 2 til 5 dager, 14 dagers retur'
          >
            <span>På lager</span>
            <span className='mx-2 text-cloud-dancer/65' aria-hidden>
              ·
            </span>
