...
export function ShippingAndReturnComponent() {
  return (
    <div className='flex flex-col gap-6'>
      <div className='rounded-lg border border-cloud-dancer/15 bg-havdyp text-foreground'>
        <div className='grid grid-cols-1 divide-y divide-cloud-dancer/15 sm:grid-cols-3 sm:divide-x sm:divide-y-0'>
          <div className='flex items-start gap-3 p-4'>
            ...
            <div className='min-w-0'>
              <p className='text-sm font-semibold text-foreground'>Rask levering 2–5 dager</p>
          ...
          <div className='flex items-start gap-3 p-4'>
            ...
            <div className='min-w-0'>
              <p className='text-sm font-semibold text-foreground'>14 dagers åpent kjøp</p>
              <p className='mt-0.5 text-xs leading-snug text-foreground/75'>
          ...
          <div className='flex items-start gap-3 p-4'>
            ...
            <div className='min-w-0'>
              <p className='text-sm font-semibold text-foreground'>På lager i Bergen</p>
              <p className='mt-0.5 text-xs leading-snug text-foreground/75'>
        ...
        <div className='border-t border-cloud-dancer/15 px-4 py-2.5'>
          <Link
            ...
            className='group inline-flex items-center gap-1.5 text-xs font-medium text-foreground/80 transition-colors hover:text-primary'
          >
