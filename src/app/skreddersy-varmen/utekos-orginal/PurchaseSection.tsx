...
// Typer for varianter
type ColorVariant = 'vargnatt' | 'fjellbla'
type SizeVariant = 'medium' | 'large'

// --- KONFIGURASJON ---
// Vi prefikser ID-ene for å sikre at Shopify API-et godtar dem (Global ID)
const GID_PREFIX = 'gid://shopify/ProductVariant/'

const variantMap: Record<ColorVariant, Record<SizeVariant, string>> = {
  vargnatt: {
...
// Hjelpefunksjon for å vente på State Machine (hentet fra din logikk)
