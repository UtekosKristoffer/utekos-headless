...
const content = {
  dry: {
    ...
    icon: <ShieldCheck className='size-6 text-maritime-darkest' aria-hidden />
  },
  wet: {
    label: 'Fuktig klima',
    ...
    icon: <Waves className='size-6 text-maritime-darkest' aria-hidden />
  }
} as const
    ...
    >
      <div className='mx-auto max-w-5xl px-6'>
        ...
        <div className='gsap-tech-intro mb-16 text-center'>
          <span className='gsap-tech-eyebrow mb-3 inline-block text-xs font-bold uppercase tracking-[0.22em] text-maritime-darkest'>
            Teknologi
          </span>
          <h2
            id='techdown-heading'
            className='gsap-tech-title mb-6 font-semibold text-4xl text-maritime-darkest text-balance leading-[0.9] tracking-[-0.01em] md:text-5xl lg:text-6xl'
          >
            Når været snur, består varmen
          </h2>
          <p className='gsap-tech-subtitle mx-auto max-w-2xl text-lg font-light leading-[1.45] tracking-[-0.02em] text-maritime-darkest md:text-xl'>
        ...
        <div className='gsap-tech-slider relative rounded-sm border border-maritime-darkest/10 bg-overcast p-2 shadow-2xl md:p-4'>
          ...
          >
            ...
            <div className='pointer-events-none absolute right-6 top-6 z-10'>
              <span className='rounded-sm border border-cloud-dancer/10 bg-maritime-darkest px-4 py-2 text-xs font-bold uppercase tracking-widest text-cloud-dancer backdrop-blur-md'>
                Fuktig vær
              </span>
            </div>
            <div className='pointer-events-none absolute left-6 top-6 z-30'>
              <span className='rounded-sm bg-cloud-dancer/90 px-4 py-2 text-xs font-bold uppercase tracking-widest text-maritime-darkest shadow-lg backdrop-blur-md'>
                Tørt vær
              </span>
            </div>
            <div
              ...
              style={{ left: `${position}%` }}
            >
              <div className='gsap-tech-handle flex h-16 w-16 -translate-x-1/2 transform items-center justify-center rounded-full border border-overcast bg-cloud-dancer text-maritime-darkest shadow-[0_8px_30px_rgba(0,0,0,0.3)] transition-transform duration-200 hover:scale-110 active:scale-95'>
        ...
        <div className='gsap-tech-card mt-12 rounded-sm border border-maritime-darkest/5 bg-overcast p-8 shadow-xl md:p-12'>
          <div className='flex flex-col items-start gap-8 md:flex-row md:gap-16'>
            <div className='flex flex-col items-start md:w-1/3'>
              <div className='gsap-tech-status-badge mb-4 flex items-center gap-3 rounded-full bg-maritime-darkest/10 px-4 py-2 text-maritime-darkest'>
                {currentContent.icon}
              ...
              <h3 className='gsap-tech-card-title text-3xl font-semibold leading-[0.95] tracking-[-0.01em] text-maritime-darkest'>
                {currentContent.title}
              </h3>
            </div>

            <div className='md:w-2/3'>
              <p className='gsap-tech-card-desc mb-8 text-lg leading-[1.5] tracking-[-0.02em] text-maritime-darkest/70'>
                {currentContent.desc}
              </p>

              <div className='border-t border-maritime-darkest pt-6'>
                <div className='mb-2 flex items-end justify-between'>
                  <span className='text-xs font-bold uppercase tracking-widest text-maritime-darkest/50'>
                    Isolasjonsevne
                  </span>
                  <span className='gsap-tech-stat text-xl font-semibold leading-[0.95] tracking-[-0.01em] text-maritime-darkest'>
                    {isDryView ? '100%' : '98%'}
                  </span>
                </div>
                <div className='h-1 w-full overflow-hidden rounded-full bg-maritime-darkest'>
                  <div
                    className='gsap-tech-progress h-full bg-maritime-darkest transition-[width] duration-1000 ease-out'
                    style={{ width: isDryView ? '100%' : '98%' }}
                  />
                </div>
                <p className='mt-2 text-xs italic leading-[1.5] tracking-[-0.02em] text-maritime-darkest/50'>
