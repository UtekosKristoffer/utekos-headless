...
export function Hero() {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className='absolute inset-0 z-1 bg-linear-to-b from-maritime-darkest/35 via-maritime-darkest/55 via-50% to-maritime-darkest/95'
      />
      <div
        aria-hidden
      ...
      <div className='relative z-10 mx-auto flex min-h-[calc(100svh-70px)] w-full max-w-350 flex-col items-start justify-center px-6 pb-16 pt-20 md:px-12 md:pt-24 lg:px-20 xl:min-h-[calc(100svh-86px)]'>
        <div className='max-w-2xl'>
          <div
            ...
            aria-hidden='true'
          >
            <UtekosWordmark className='size-full text-cloud-dancer' />
          </div>
          <h1
            id='hero-headline'
          ...
          >
            ...
            <span className='mt-3 text-left block max-w-4xl font-google-sans text-3xl font-bold italic text-iced-apricot sm:text-4xl md:text-5xl lg:text-6xl'>
              Forleng kvelden.
            </span>
          </h1>

          <p className='mt-7 max-w-xl font-google-sans text-base leading-text-paragraph text-cloud-dancer/90 drop-shadow-md md:text-lg lg:text-xl'>
          ...
          <div
            className='mt-9 flex items-center gap-3 text-sm text-cloud-dancer md:text-[15px]'
          ...
          <p
            className='mt-5 flex w-fit max-w-full flex-nowrap items-center whitespace-nowrap font-google-sans text-xs font-medium leading-text-paragraph tracking-normal text-cloud-dancer/80 md:text-sm'
            aria-label='På lager, levering 2 til 5 dager, 14 dagers retur'
          >
            <span>På lager</span>
            <span className='mx-2 text-cloud-dancer/40' aria-hidden>
              ·
            </span>
            <span>Levering 2–5 dager</span>
            <span className='mx-2 hidden text-cloud-dancer/40 lg:inline' aria-hidden>
              ·
            </span>
