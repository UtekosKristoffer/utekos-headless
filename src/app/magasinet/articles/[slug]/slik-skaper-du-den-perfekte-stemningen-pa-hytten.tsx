  ...
  return (
    <article className='md:max-w-4xl mx-auto'>
      ...
      <p className='text-lg text-article-white/80'>
        Ordet &quot;hyttekos&quot; er nesten hellig for oss nordmenn. Det fremkaller bilder av snødekte
        landskap, knitrende peisbål og en dyp følelse av ro. Men hva er det egentlig som skaper denne magiske
        stemningen? Det er en nøye balansert formel av fire elementer som jobber sammen for å påvirke sansene
        våre.
      </p>
      ...
      <Card className='bg-sidebar-foreground border-neutral-800 my-8'>
        <CardContent className='p-6'>
          <p className='text-article-white/80 mt-0'>
            Den perfekte hyttestemningen er en sum av fire deler. Når du bevisst jobber med alle fire, løfter
            du opplevelsen til et nytt nivå:
          </p>
          <div className='mt-6'>
            <HyttekosFlow />
          </div>
      ...
      <Card className='my-12 text-center bg-gradient-to-br from-primary/20 to-transparent border-neutral-800'>
        <CardContent className='p-8'>
          ...
          <p className='text-article-white/80 mt-2 mb-6'>
            Utekos er designet for å være din personlige komfortsone, slik at du kan nyte de magiske
            øyeblikkene på hytten – både inne og ute.
          </p>
          <Button asChild>
            <Link href='/produkter'>
      ...
      <Card className='relative overflow-hidden my-12 bg-sidebar-foreground border-neutral-800'>
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, #facc1520 0%, transparent 100%)'
          }}
        />

        <div className='absolute inset-0 rounded-lg blur-xl opacity-20' style={{ background: '#facc15' }} />
        ...
        <CardContent className='relative z-10 p-8'>
          ...
          <p className='text-article-white/80 mt-4'>
            Ved å bevisst tenke på samspillet mellom lys, lyd, tekstur og varme, går du fra å bare være på
            hytten, til å aktivt skape den dype, meningsfulle roen som er ekte hyttekos. Det er en kunst, men
