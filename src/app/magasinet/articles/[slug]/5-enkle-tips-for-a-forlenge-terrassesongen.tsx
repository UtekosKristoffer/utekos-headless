    ...
    <article className='prose prose-invert prose-lg max-w-4xl mx-auto'>
      ...
      <Activity>
        <p>
          ...
          en ren sommerdestinasjon til et favorittsted som kan brukes store
          deler av året. Ved å kombinere varme, skjerming, gode materialer og
          riktig lys skaper du en sone som faktisk inviterer til bruk – også når
          temperaturen faller. Løsningene er skalerbare for både små og store
          uteplasser, enkle å sette ut i livet, og tilpasset nordisk klima. Her
          er fem nøkkelelementer visualisert for deg:
        </p>
      </Activity>
      ...
      <Activity>
        <p>
          ...
          selv varm. Med målrettet kroppsnær varme holder du jevn temperatur
          selv i trekk, bruker mindre energi, og kan sitte lengre uten å flytte
          deg nærmere flammen. Kombinér derfor lag med ull og skinn,
          vindskjerming i sittehøyde og en personlig varmekilde som treffer
          overkropp og hender—så får du umiddelbar, stabil komfort uten
          overoppheting av omgivelsene. Resultatet er mer tid ute, mindre
          energisvinn og en terrasse som faktisk leverer på kos hele
          sesongen.{' '}
        </p>
      </Activity>
        ...
        <Card className='my-12 not-prose bg-sidebar-foreground border-neutral-800'>
          <CardContent className='p-8'>
            ...
            <p className='text-muted-foreground mt-4'>
              Ved å kombinere disse fem elementene tar du aktivt kontroll over
              din egen utendørssesong. Du er ikke lenger en passiv tilskuer til
              været, men en aktiv skaper av dine egne, komfortable øyeblikk. Nyt
              høsten, og ønsk våren velkommen tidligere enn noen gang før.
            </p>
          </CardContent>
        </Card>
      </Activity>
