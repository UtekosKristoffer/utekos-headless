...
import { nodeTypes } from '@/app/magasinet/slik-skaper-du-den-perfekte-stemningen-pa-hytten/@constants/nodeTypes'
import { initialEdges } from './@constants/initialEdges'
import { initialNodes } from './@constants/initialNodes'

export default function TerrasseTipsFlow() {
  return (
    <div className='h-[560px] w-full bg-background rounded-lg border border-neutral-800 overflow-hidden'>
      <ReactFlowProvider>
        <ReactFlow
          nodes={initialNodes}
          edges={initialEdges}
