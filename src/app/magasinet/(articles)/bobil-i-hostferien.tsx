// Path: src/app/magasinet/(articles)/bobil-i-hostferien.tsx
    ...
    <article className='prose prose-invert prose-lg max-w-4xl mx-auto'>
      ...
      <Activity>
        <p>
          ...
          Turistmengdene har avtatt, luften er skarp og klar, og naturen setter
          på seg sin mest fargerike drakt. Friheten til å stoppe der du vil,
          koke kaffe med utsikt over et blikkstille fjellvann, og våkne til nye,
          gylne landskap hver dag, er uslåelig.
        </p>
        <p>
        ...
        <Card className='my-12 not-prose bg-sidebar-foreground border-neutral-800'>
          <CardContent className='p-8'>
            ...
            <p className='text-muted-foreground mt-4'>
              Høstferien er en gyllen mulighet til å oppleve Norge på en ny
              måte. Med en varm og komfortabel base i bobilen, er det bare å
              fylle dieseltanken og la fargene vise vei. God tur!
            </p>
          </CardContent>
        </Card>
      </Activity>
