// Path: src/app/magasinet/(articles)/vinterklargjoring-av-hytta.tsx
    ...
    <article className='md:max-w-4xl mx-auto'>
      ...
      <Activity>
        <p className='text-lg text-article-white/80'>
          ...
          starter. Vi har brutt ned prosessen i tre oversiktlige hovedområder:
        </p>
      </Activity>
      ...
      <Activity>
        <p className='text-lg text-article-white/80 mt-8'>
          ...
          ved neste ankomst. En kald hytte kan ta timer å varme opp, og det er
          da øyeblikkelig personlig varme blir den ultimate luksusen.
        </p>
      </Activity>
