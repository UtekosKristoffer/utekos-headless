// Path: src/app/magasinet/(articles)/balpannen-din-guide-til-den-perfekte-hostkvelden.tsx
    ...
    <article className='md:max-w-4xl mx-auto'>
      ...
      <Activity>
        <p className='text-lg text-access/80'>
          Men en virkelig vellykket kveld rundt bålpannen handler om mer enn
          bare å tenne et bål. Det handler om å skape en ramme av trygghet,
          hygge og ikke minst, varig komfort. Med litt planlegging får dere jevn
          varme, god flyt og færre avbrytelser gjennom kvelden. For å hjelpe deg
          på veien har vi laget en enkel huskeliste: &quot;De 5 P-ene for
          perfekt bålkos&quot; – en rask sjekk som sikrer riktig plassering,
          riktig utstyr og riktig stemning fra start til slutt.
        </p>
      </Activity>
