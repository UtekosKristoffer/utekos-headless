...
const techDownFeatures = [
  {
    ...
    description: 'En elegant silhuett som gir full bevegelsesfrihet uten unødvendig volum.'
  },
  {
    Icon: StretchHorizontal,
    title: 'Justerbar midje',
    description: 'Innvendig snorstramming lar deg enkelt forme silhuetten og stenge den kalde trekken ute.'
  },
  {
    Icon: GitCommitVertical,
    title: 'Kvalitet i detaljene',
    description: 'YKK®-glidelåser i verdensklasse garanterer langvarig og problemfri bruk.'
  }
]
      ...
      <div className='bg-havdyp text-cloud-dancer'>
        <div className='container mx-auto px-4 py-16 text-center sm:py-24'>
          ...
          <div className='mt-12 max-w-3xl mx-auto text-left space-y-6 text-cloud-dancer'>
            ...
            <p>
              Valget ditt bør baseres på hvordan du har tenkt til å bruke den og hvilken passform du
              foretrekker for tekniske plagg.
            </p>
          </div>
          ...
          <div className='mt-20 max-w-4xl mx-auto'>
            <h3 className='text-2xl font-bold   sm:text-3xl'>Gjennomtenkte detaljer for din komfort</h3>
