...
export function ComfyrobeSizeGuide() {
  return (
    <section className='bg-cloud-dancer text-maritime-darkest'>
            ...
            {comfyrobeFeatures.map(feature => (
              <div key={feature.title} className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='mt-1 text-sm text-maritime-darkest/70'>
                    {feature.description}
                  </p>
                </div>
              </div>
          ...
          <div className='flex items-start gap-4'>
            ...
            <div>
              ...
              <p className='mt-1 text-maritime-darkest/74'>
                ...
                er romslig, men som følger deg? Velg din normale størrelse. Ser
                du for deg maksimal plass til tykke lag under, eller en bevisst
