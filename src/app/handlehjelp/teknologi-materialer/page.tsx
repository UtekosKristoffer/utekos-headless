...
function TechnologyJsonLd() {
  const jsonLd = [
    {
      '@context': 'https://schema.org',
      '@type': 'WebPage',
      'name': 'Teknologi & Materialer | Utekos®',
      'description':
        'Utforsk teknologien bak Utekos® og vår 3-i-1 adaptiv funksjonalitet. Skreddersydd for nordiske forhold med TechDown™ og HydroGuard™.',
      'url': 'https://utekos.no/handlehjelp/teknologi-materialer'
    },
    {
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
      'mainEntity': [
        {
          '@type': 'Question',
          'name': 'Hva er Utekos 3-i-1 funksjonalitet?',
          'acceptedAnswer': {
            '@type': 'Answer',
            'text':
              'Gjennom et integrert system av snorstrammere transformeres plagget sømløst mellom tre moduser: Fullengde for maksimal stasjonær isolasjon, Oppjustert for umiddelbar mobilitet, og Parkas for aktiv bevegelse og estetisk silhuett.'
          }
        },
        {
          '@type': 'Question',
          'name': 'Hva er Utekos TechDown™?',
          'acceptedAnswer': {
            '@type': 'Answer',
            'text':
              'TechDown™ er en avansert syntetisk isolasjonsstruktur (CloudWeave™) utviklet for å etterligne dunets loft, men med hydrofobiske egenskaper som bevarer varme selv når det er fuktig, kombinert med premium Luméa™ Shell ytterstoff.'
          }
        },
        {
          '@type': 'Question',
          'name': 'Hva er Comfyrobe™?',
          'acceptedAnswer': {
            '@type': 'Answer',
            'text':
              'Comfyrobe™ er vår bade- og skiftekåpe bygget med HydroGuard™ Shell (8000mm vannsøyle) for total værbeskyttelse og SherpaCore™ Thermal Lining som gir umiddelbar varme og absorberer restfuktighet – ideell etter isbad og vannsport.'
          }
        },
        {
          '@type': 'Question',
          'name': 'Hvor vanntett er Utekos sine plagg?',
          'acceptedAnswer': {
            '@type': 'Answer',
            'text':
              'Comfyrobe™ benytter HydroGuard™ med 8000mm vannsøyle og tapede sømmer. Våre dun soveposer og mikrofiberprodukter bruker DWR Performance Nylon (DuraLite™) som er sterkt vannavvisende og vindtett.'
          }
        }
      ]
    }
          ...
          <div className='grid gap-6 md:grid-cols-3'>
            ...
            <div className='group relative overflow-hidden rounded-3xl border border-white/10 bg-maritime-blue/80 p-8 backdrop-blur-xl transition-all duration-500 hover:border-ancient-water/30 hover:bg-maritime-blue hover:shadow-2xl hover:shadow-ancient-water/20'>
              ...
              <div className='relative z-10'>
                ...
                <p className='text-cloud-dancer/70 font-utekos-text leading-relaxed text-sm tracking-tight'>
                  Utgangspunktet for selve utekosen. Plagget henger i full
                  lengde som en isolerende kokong. Perfekt for solveggen,
                  hengekøyen eller lange kvelder på terrassen.
                </p>
              </div>
            </div>
            ...
            <div className='group relative overflow-hidden rounded-3xl border border-white/10 bg-maritime-blue/80 p-8 backdrop-blur-xl transition-all duration-500 hover:border-dusted-peri/30 hover:bg-maritime-blue hover:shadow-2xl hover:shadow-dusted-peri/20'>
              ...
              <div className='relative z-10'>
                ...
                <p className='text-cloud-dancer/70 font-utekos-text leading-relaxed text-sm tracking-tight'>
                  ...
                  kjøkkenet eller svare telefonen? Heis opp plagget til ønsket
                  lengde, stram snoren i livet og bli mobil på sekunder. Beveg
                  deg trygt og subbefritt – uten å miste varmen.
                </p>
              </div>
            </div>
          ...
          <div className='container mx-auto px-4'>
            <div className='grid gap-8 md:grid-cols-2'>
              ...
              >
                ...
                <p className='mb-8 max-w-sm font-utekos-text text-cloud-dancer/70 tracking-tight'>
