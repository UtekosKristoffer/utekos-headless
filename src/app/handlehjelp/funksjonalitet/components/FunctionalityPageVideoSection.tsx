      ...
      <div className='overflow-hidden rounded-3xl bg-neutral-900 text-white shadow-2xl'>
        <div className='grid lg:grid-cols-2'>
          ...
          <div className='flex flex-col justify-center p-8 lg:p-16'>
            ...
            <h2 className='text-3xl font-bold sm:text-4xl'>Slik fungerer det i praksis</h2>
            <p className='mt-4 text-neutral-300'>
              Det er enklere enn du tror. Se videoen for å lære hvordan du på sekunder tilpasser din Utekos
              til situasjonen du befinner deg i. Fra full avslapning til full mobilitet.
            </p>
