...
export function ComparisonSection() {
  return (
    <section id='sammenligning' className='overflow-hidden bg-havdyp py-20 text-foreground sm:py-28'>
      <div className='mx-auto max-w-7xl px-[6vw]'>
        <div className='mb-12 grid gap-8 text-center'>
          <div>
            ...
            />
            <h2 className='text-foreground'>Sammenlign egenskapene</h2>
          </div>
          <p className='max-w-2xl mx-auto text-foreground utekos-section-lead'>
