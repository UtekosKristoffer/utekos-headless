          ...
          {deepDiveSections.map(section => (
            <li key={section.title}>
              <article className='mx-auto max-w-4xl py-10 lg:py-14'>
                <p className='font-utekos-text text-sm font-medium tracking-tight text-maritime-darkest'>
                  {section.eyebrow}
                </p>
                <h3 className='mt-4 font-google-sans text-3xl leading-[0.98] font-bold tracking-tight text-maritime-darkest sm:text-4xl'>
                  {section.title}
                </h3>

                <ul className='mt-7 list-disc space-y-4 pl-5 font-utekos-text text-base font-medium leading-[1.45] tracking-tight text-maritime-darkest marker:text-primary-button sm:text-lg'>
