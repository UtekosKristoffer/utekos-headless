...
export function ComparisonTable() {
  return (
    <div className='max-w-full overflow-x-auto border rounded-xl border-havdyp/14 bg-cloud-dancer [contain:paint]'>
      <table className='w-full min-w-[880px] border-collapse text-left'>
        ...
        <tbody>
          {comparisonRows.map(row => (
            <tr key={row.feature} className='border-b border-havdyp/12'>
              <th
                scope='row'
