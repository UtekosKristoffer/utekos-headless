...
export function ProductCareUtekosDun() {
  return (
    ...
    >
      <h3 className='text-2xl font-semibold   text-background'>Utekos Dun™</h3>
      ...
      <div className='mt-7 rounded-2xl border border-cloud-dancer/12 bg-havdyp p-5 text-foreground sm:p-6'>
        <div className='flex items-start gap-3'>
          ...
          <div>
            <h4 className='text-base font-semibold   text-foreground sm:text-lg'>Tørking er avgjørende</h4>
      ...
      <div className='mt-5 rounded-2xl border border-background/10 bg-[color-mix(in_oklab,var(--ancient-water)_54%,var(--cloud-dancer)_46%)] p-5 text-background sm:p-6'>
        <div className='flex items-start gap-3'>
          <span
            aria-hidden='true'
            className='flex size-9 shrink-0 items-center justify-center rounded-full border border-havdyp/28 bg-havdyp text-foreground'
          >
            <Wind className='size-[1.05rem]' />
          </span>
          <div>
            <h4 className='text-base font-semibold   text-background sm:text-lg'>
              Oppbevaring mellom sesongene
            </h4>
            <p className='mt-2 text-sm leading-relaxed    text-background/82 sm:text-base'>
