  ...
  return (
    <header className='mx-auto max-w-3xl'>
      <nav aria-label='Brødsmulesti' className='mb-8'>
        <ol className='flex flex-wrap items-center gap-1.5 text-sm text-background/70'>
          <li>
          ...
          <li aria-current='page' className='text-background'>
            Vask og vedlikehold
          </li>
        </ol>
      </nav>
      ...
      <div className='text-center'>
        ...
        />
        <h1 className='text-3xl font-bold leading-[1.05]   text-background sm:text-5xl'>
          Bevar varmen i din{' '}
        ...
        <p className='mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-background/82'>
