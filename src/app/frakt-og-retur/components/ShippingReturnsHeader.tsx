  ...
  return (
    <header className='mx-auto max-w-5xl text-center'>
      <nav
        ...
        className='mb-8 flex items-center justify-center gap-2 text-sm leading-[1.4]   text-background/80'
      >
      ...
      />
      <h1 className='text-4xl font-bold leading-[1.45]   font-google-sans text-background sm:text-4xl md:text-5xl lg:text-6xl'>
        Frakt og retur - enkelt og trygt
      </h1>
      <p className='mx-auto mt-4   max-w-3xl text-lg font-medium md:text-xl leading-[1.45]   text-background'>
