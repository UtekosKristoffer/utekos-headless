    ...
    <aside className='lg:col-span-4'>
      <Card className='sticky top-28 border-cloud-dancer/12 bg-ancient-water text-background shadow-[0_24px_70px_-52px_rgba(8,12,28,0.88)]'>
          ...
          <ul className='space-y-4'>
            <li className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-sm leading-text-paragraph   text-background/80'>
            ...
            <li className='flex items-start gap-3'>
              ...
              <div>
                <h4 className='leading-text-paragraph text-md font-medium     text-background'>Retur</h4>
                <address>
                  <p className='text-sm leading-text-paragraph   text-background/80'>
        ...
        <CardFooter className='flex-col items-start'>
          <h4 className='leading-text-paragraph text-md font-medium     text-background'>
          ...
          <BrandBadge
            ...
            className='min-h-12 mt-4 w-full border border-cloud-dancer/24 px-6 py-3 text-base leading-4 font-bold   shadow-xl transition-transform duration-300 hover:-translate-y-0.5 hover:brightness-105'
          >
