      ...
      >
        ...
        <CardContent className='relative flex h-full flex-col gap-3 p-5'>
          <div className='flex items-center gap-3'>
            ...
            <h3
              className='inspirational-page-hero-card-heading whitespace-nowrap text-maritime-darkest'
          ...
          <p
            className='inspirational-page-hero-card-description pr-2 text-maritime-darkest/90'
