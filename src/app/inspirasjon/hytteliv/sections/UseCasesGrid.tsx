...
export const useCasesData: UseCase[] = [
  ...
  },
  {
    ...
    description:
      'God ved ankomst til en kald hytte. Få varmen mens du fyrer i peisen.',
...
const useCaseCardThemes = [
  {
    surface:
      'color-mix(in oklch, var(--cloud-dancer) 78%, var(--ancient-water))',
    border:
      'color-mix(in oklch, var(--ancient-water) 44%, var(--maritime-darkest))',
  ...
  {
    surface:
      'color-mix(in oklch, var(--cloud-dancer) 78%, var(--bleached-mauve))',
    border:
      'color-mix(in oklch, var(--bleached-mauve) 44%, var(--maritime-darkest))',
  ...
  {
    surface:
      'color-mix(in oklch, var(--cloud-dancer) 76%, var(--mountain-view))',
    border:
      'color-mix(in oklch, var(--mountain-view) 46%, var(--maritime-darkest))',
    ...
    <section id='bruksomrader' className='bg-overcast py-24'>
      <div className='container mx-auto px-4'>
        <div className='mx-auto mb-16 max-w-2xl text-center'>
          <h2 className='text-fluid-display leading-[0.95] font-bold tracking-[-0.01em] text-maritime-darkest'>
            Hyttekos fra morgen til kveld
          </h2>
          <p className='mt-4 text-lg leading-[1.45] tracking-[-0.01em] text-maritime-darkest'>
            Fra første kaffekopp til siste vedkubbe får du varme når hyttedagen
            ber om det.
          </p>
        </div>
        <div className='grid grid-cols-1 gap-8 md:grid-cols-3'>
          {useCases.map((useCase, useCaseIndex) => {
            const theme =
              useCaseCardThemes[useCaseIndex % useCaseCardThemes.length]
              ?? useCaseCardThemes[0]
                  ...
                  <CardContent className='relative flex h-full flex-col p-7 sm:p-8'>
                    <div className='mb-6 flex items-start justify-between gap-4'>
                      ...
                      <p
                        ...
                        style={{
                          backgroundColor:
                            'color-mix(in oklch, var(--cloud-dancer) 72%, var(--overcast))',
                          borderColor: theme.border,
                    ...
                    <h3 className='text-balance text-2xl leading-[1] font-semibold tracking-[-0.01em] text-maritime-darkest'>
                      {useCase.title}
                    </h3>
