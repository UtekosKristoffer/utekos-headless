    ...
    <section className='bg-overcast py-24'>
      <div className='container mx-auto px-4'>
        <div className='mx-auto max-w-3xl text-center'>
          <h2 className='mb-8 text-fluid-display font-bold leading-[0.95] tracking-[-0.01em] text-maritime-darkest'>
            <span className='inline-flex flex-wrap items-baseline justify-center gap-x-[0.22em] gap-y-2'>
              <span>Huseiere elsker</span>
              <UtekosWordmark className='inline-block h-[0.72em] w-auto -translate-y-[0.035em] text-maritime-darkest' />
            </span>
          </h2>
            ...
            <CardContent className='p-8 sm:p-12'>
              ...
              <div className='flex items-center justify-center gap-4'>
                ...
                <div className='text-left'>
                  <p className='font-semibold leading-[1.25] tracking-[-0.01em] text-cloud-dancer'>
                    Kristin
                  </p>
