      ...
      <div className='container mx-auto max-w-7xl'>
        <div className='mb-12 text-center'>
          ...
          <h2
            ref={h2Ref}
            className={cn(
              'will-animate-fade-in-up text-3xl font-bold tracking-tight sm:text-4xl mt-4 lg:text-5xl',
              h2InView && 'is-in-view'
            )}
                ...
                {terrasseImages.map((image, index) => (
                  ...
                  >
                    <div className='group relative h-[350px] w-full overflow-hidden rounded-xl border border-neutral-800 transition-all duration-300 hover:border-neutral-700'>
                      ...
                      />
                      <div className='relative flex size-full aspect-[3/2] items-center'>
                        <AspectRatio
                          ratio={3 / 2}
                        ...
                        >
                          <Image
                            ...
                            alt={image.alt}
                            fill
                            className='object-cover transition-transform place-self-center flex duration-700 group-hover:scale-102'
