  ...
  return (
    <section className='relative overflow-hidden bg-overcast px-4 py-20 sm:px-6 lg:px-8'>
      ...
      >
        ...
        <h2 className='mt-4 max-w-3xl text-balance text-4xl font-google-sans *:font-semibold   text-background sm:text-5xl'>
        ...
        <Button
          ...
          size='lg'
          className='mt-9 h-12 rounded-md bg-primary px-6 text-[15px] font-semibold text-background hover:bg-primary/90'
        >
          <Link
            href='/produkter'
            data-track='NbccFinalProductsClick'
