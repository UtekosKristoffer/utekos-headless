...
import { CloudRain, ThermometerSnowflake, Flame, Shield, Wind } from 'lucide-react'
...
export function ProblemSolutionSection() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(warmTextRef.current, { autoAlpha: 0, scale: 1.1 }, { autoAlpha: 1, scale: 1, duration: 4 }, 2)
    ...
    <section ref={sectionRef} className='relative bg-[#0a0a0a]'>
      <div ref={triggerRef} className='relative h-screen w-full overflow-hidden'>
        <div className='absolute inset-0 bg-slate-900 flex items-center justify-center z-10'>
          ...
          <div ref={coldTextRef} className='relative z-20 text-center px-4 max-w-2xl'>
            ...
            <p className='text-lg text-slate-400 leading-relaxed'>
              Vindkast som skjærer gjennom marg og bein. Regn som finner veien inn overalt. Den norske kulden
              tar ingen pauser.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div ref={warmTextRef} className='relative z-20 text-center px-4 max-w-2xl'>
            <div className='flex justify-center gap-4 mb-6'>
            ...
            <p className='text-xl text-slate-300 leading-relaxed font-light mb-8'>
              Fra storm til stillhet på et sekund. Comfyrobe™ stenger verden ute og holder varmen inne. Din
              personlige festning.
            </p>
