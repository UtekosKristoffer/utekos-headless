...
const ProductGallery = dynamic(
  ...
  {
    loading: () => <div className='relative aspect-9/16 w-full overflow-hidden rounded-none' />,
    ssr: false
  }
)
...
export function ProductPageView({
  ...
  const overrideImages = PRODUCT_GALLERY_IMAGE_OVERRIDES[productData.handle]
  ...
  const priceActivityPanel = (
    <div
      ...
      className='relative pt-2 text-foreground! mt-4 md:mt-0'
    >
      <PriceActivityPanel
        productHandle={productData.handle}
        priceAmount={selectedVariant.price.amount ?? '0'}
        currencyCode={selectedVariant.price.currencyCode}
        limitedStockCount={limitedStockCount ? limitedStockCount : 0}
  ...
  return (
    <article className='relative isolate overflow-x-clip bg-background py-0 text-foreground! md:py-6'>
      ...
      <div className='container mx-auto px-4 md:px-8'>
        <DesktopBreadcrump productTitle={title} handle={productData.handle ?? ''} />
