...
export function TrustSignals() {
  return (
    <div
      className='mb-6 mt-6 overflow-hidden rounded-[1.25rem] border border-cloud-dancer/70 bg-cloud-dancer/72 shadow-xl shadow-havdyp/10 backdrop-blur-sm'
      role='complementary'
      aria-label='Trygghetsinformasjon'
    >
      <div className='hidden md:block'>
        <div className='grid grid-cols-3 gap-4 border-b border-havdyp/10 px-6 py-5'>
          <Link
            href='/frakt-og-retur'
        ...
        <div className='px-6 py-4'>
          <div className='flex items-center justify-center gap-5'>
            ...
            <div className='flex items-center rounded-md bg-white px-2.5 py-1'>
              <Image src={ApplePayLogo} alt='Apple Pay' className='h-[16px] w-auto' />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='flex flex-col md:hidden'>
        ...
        >
          ...
          <div>
            <span className='block text-sm font-semibold leading-tight text-havdyp'>
              14 dagers åpent kjøp
            </span>
            <span className='mt-0.5 block text-xs text-havdyp/62'>Uten spørsmål</span>
          </div>
        </Link>
        ...
        >
          ...
          <div>
            <span className='block text-sm font-semibold leading-tight text-havdyp'>Trygg handel</span>
            <span className='mt-0.5 block text-xs text-havdyp/62'>Sikker betaling</span>
          </div>
        </Link>
        ...
        <div className='px-5 py-4'>
          <div className='flex flex-wrap items-center justify-center gap-4'>
            ...
            <Image src={GooglePayLogo} alt='Google Pay' className='h-[18px] w-auto opacity-90' />
            <div className='flex items-center rounded-md bg-white px-2.5 py-1'>
              <Image src={ApplePayLogo} alt='Apple Pay' className='h-[16px] w-auto' />
            </div>
          </div>
