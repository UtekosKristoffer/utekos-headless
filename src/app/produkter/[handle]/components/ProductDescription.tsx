...
export function ProductDescription({ descriptionHtml: descriptionJson }: ProductDescriptionProps) {
  ...
  return (
    <article
      ...
      className='mt-12 rounded-[1.25rem] border border-background bg-cloud-dancer p-5 shadow-lg shadow-cloud-dancer/5'
    >
      <div aria-live='polite' aria-atomic='true' className='relative overflow-hidden'>
        ...
        >
          <div
            className='font-google-sans max-w-none text-muted [&_p]:text-base [&_p]:leading-relaxed [&_p+p]:mt-3'
      ...
      <div className='mt-4'>
        <Button
          ...
          className='p-0 text-lg text-background hover:text-havdyp/76'
        >
