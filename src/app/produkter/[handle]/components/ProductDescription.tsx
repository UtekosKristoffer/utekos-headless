...
export function ProductDescription({ descriptionHtml: descriptionJson }: ProductDescriptionProps) {
  ...
  return (
    <article
      ...
      className='mt-12 rounded-[1.25rem] border border-muted-foreground bg-background p-5 shadow-lg shadow-muted-foreground/5'
    >
      <div aria-live='polite' aria-atomic='true' className='relative overflow-hidden'>
        ...
        >
          <div
            className='font-utekos-text text-foreground font-base max-w-none tracking-wide leading-[1.5] [&_p]:text-base [&_p]:leading-relaxed [&_p+p]:mt-3'
