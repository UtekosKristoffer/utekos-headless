...
import { choices } from '@/app/produkter/(oversikt)/utils/choices'
import { getGlowColor } from '@/app/produkter/(oversikt)/utils/getGlowColor'
import { helpChooseSectionPricing } from '@/app/produkter/(oversikt)/utils/helpChooseSectionPricing'
    ...
    <section className='relative mb-24 w-full px-4 md:px-6'>
      ...
      <div className='grid w-full grid-cols-2 gap-4 lg:grid-cols-4 lg:gap-6'>
        {choices.map((choice, index) => {
          ...
          const { price, before } = helpChooseSectionPricing[index] || {
            price: '',
            before: ''
          }
