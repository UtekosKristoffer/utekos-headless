    ...
    >
      ...
      <div className='container mx-auto grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20'>
        <div className='gsap-visual w-full'>
          <div className='relative rounded-2xl border border-cloud-dancer/10 bg-cloud-dancer/4 p-2 backdrop-blur-sm shadow-[0_32px_80px_-44px_rgba(8,15,24,0.92)]'>
            <div className='absolute top-4 right-4 z-20 rotate-6 md:-top-4 md:-right-4 md:rotate-3'>
              <div className='flex h-24 w-24 flex-col items-center justify-center rounded-4xl bg-very-peri p-4 text-background shadow-[0_20px_45px_-24px_rgba(32,28,54,0.58)] ring-1 ring-background/8'>
              ...
              <CarouselContent>
                {TechDownImages.map((image, index) => (
                  <CarouselItem key={image.src.src} className='p-3 sm:p-4'>
                    <div className='relative aspect-4/5 w-full overflow-hidden rounded-3xl bg-cloud-dancer/4 p-3 sm:p-4'>
        ...
        <div className='flex flex-col items-start px-4 lg:px-0'>
          ...
          <div className='gsap-content mb-10 flex items-end gap-3 rounded-xl border border-cloud-dancer/10 bg-cloud-dancer/5 p-4 backdrop-blur-sm'>
            ...
            <div className='mx-2 h-8 w-px-cloud-dancer/10'></div>
          ...
          <ul className='mb-10 w-full space-y-3'>
            {TechDownfeatures.map((feature, index) => (
              <li
                key={index}
                className='gsap-feature-item group flex items-center gap-4 rounded-xl border border-transparent bg-cloud-dancer/3transition-all duration-300 hover:translate-x-1 hover:border-cloud-dancer/14 hover:bg-cloud-dancer/8'
              >
