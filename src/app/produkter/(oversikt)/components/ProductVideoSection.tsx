          ...
          <div className='text-center lg:text-left'>
            ...
            <div className='mt-12'>
              <Link
                ...
                className='group/btn inline-flex w-full sm:w-auto items-center justify-center rounded-full bg-[var(--primary-button)] px-8 py-4 text-[1rem] font-medium text-havdyp transition-all duration-300 hover:bg-white hover:scale-[1.02] hover:shadow-[0_8px_20px_rgba(255,255,255,0.2)] focus:outline-none focus:ring-2 focus:ring-dusted-peri focus:ring-offset-2 focus:ring-offset-havdyp'
              >
                Opplev Utekos selv
