  ...
  return (
    ...
    >
      <Carousel className='w-full overflow-hidden aspect-square' opts={{ align: 'start', loop: true }}>
        ...
        <CarouselPrevious className='left-4 hidden border-background/10 bg-cloud-dancer/86 text-background backdrop-blur-md hover:bg-primary focus-visible:ring-primary/70 sm:inline-flex' />
        <CarouselNext className='right-4 hidden border-background/10 bg-cloud-dancer/86 text-background backdrop-blur-md hover:bg-primary focus-visible:ring-primary/70 sm:inline-flex' />
      </Carousel>
    </div>
  )
}
