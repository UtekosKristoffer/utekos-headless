...
export function CreatedForSection() {
  ...
  return (
    <div
      ref={container}
      className='relative mb-12 w-full rounded-3xl mt-6 overflow-hidden border-y border-white/5 bg-overcast py-8 text-center md:mb-20 md:py-32'
    >
      <div className='absolute inset-0 -z-10 pointer-events-none overflow-hidden'>
        ...
        <div className='gsap-blob-1 absolute left-[30%] top-[20%] size-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-bleached-mauve blur-[120px] mix-blend-screen' />
      ...
      <div className='relative z-10 container mx-auto px-4 flex flex-col items-center'>
        <div className='gsap-icon-wrapper mb-10 will-change-transform'>
          <div className='gsap-icon-glow flex h-16 w-16 items-center justify-center rounded-full border border-white/10 bg-bleached-mauve/80 shadow-[0_0_15px_rgba(255,255,255,0.05)] backdrop-blur-sm'>
            <Heart className='size-7 text-bleached-mauve fill-bleached-mauve' />
          </div>
        </div>
