...
| JSON representation                                                        |
| :------------------------------------------------------------------------- |
| `{   "requests": [     {       object (RunPivotReportRequest)     }   ] }` |

| Fields       |                                                                                                                                                          |
| :----------- | :------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `requests[]` | `object (RunPivotReportRequest)` Individual requests. Each request has a separate pivot report response. Each batch request is allowed up to 5 requests. |
...
| JSON representation                                                                               |
| :------------------------------------------------------------------------------------------------ |
| `{   "pivotReports": [     {       object (RunPivotReportResponse)     }   ],   "kind": string }` |

| Fields           |                                                                                                                                                                                                |
| :--------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pivotReports[]` | `object (RunPivotReportResponse)` Individual responses. Each response has a separate pivot report request.                                                                                     |
...
| `returnPropertyQuota` | `boolean` Toggles whether to return the current state of this Google Analytics property's quota. Quota is returned in [PropertyQuota](https://developers.google.com/analytics/devguides/reporting/data/v1/rest/v1beta/properties/batchRunPivotReports#PropertyQuota).                                                                                                                                                                                                                                      |
