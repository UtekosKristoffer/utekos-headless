# Recommended Events | Google Tag Manager

Google Analytics sends some event types automatically. This page describes
optional, additional events you can configure to measure more behaviors and
generate more useful reports for your business. These additional events take
more effort to configure before you can use them, so Google Analytics 4 can't
send them automatically. For step-by-step instructions on how to configure
recommended and custom events for your website or app, see
[Set up events](https://support.google.com/analytics/answer/9267735).

When using Tag Manager:
...
> **Note:** To ensure data populates properly in reports, follow the format in
> this document. If you need to set the items array outside of the ecommerce
