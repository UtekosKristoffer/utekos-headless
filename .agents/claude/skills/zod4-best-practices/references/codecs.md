...
- [Type-safe inputs](#type-safe-inputs)
- [Async and safe variants](#async-and-safe-variants)
- [How encoding works](#how-encoding-works)
- [Useful codecs](#useful-codecs)
...
> **Note** — [Stringbool](./defining-schemas.md#stringbools) pre-dates the introduction of codecs in Zod. It has since been internally re-implemented as a codec.
