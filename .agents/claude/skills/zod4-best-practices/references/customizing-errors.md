...
- [The `error` param](#the-error-param)
- [Per-parse error customization](#per-parse-error-customization)
- [Global error customization](#global-error-customization)
...
> For a breakdown of all Zod issue codes, see the [`zod/v4/core`](./zod-core.md#issues) documentation.
