...
name: performance
description:
  Optimize web performance for faster loading and better user experience. Use
  when asked to "speed up my site", "optimize performance", "reduce load time",
...
Deep performance optimization based on Lighthouse performance audits. Focuses on
...
- **TTFB < 800ms.** Time to First Byte should be fast. Use CDN, caching, and
  efficient backends.
- **Enable compression.** Gzip or Brotli for text assets. Brotli preferred
  (15-20% smaller).
...
For Core Web Vitals specific optimizations, see
