...
Zod 4+ also provides native `.toJSONSchema()` support that leverages registries to generate idiomatic JSON Schema. See [JSON Schema](./jsonSchema.md) for the conversion APIs.

## Table of Contents

- [Registries](#registries)
- [Metadata](#metadata)
- [`z.globalRegistry`](#zglobalregistry)
- [`.meta()`](#meta)
- [`.describe()`](#describe)
