...
- [100x reduction in `tsc` instantiations](#100x-reduction-in-tsc-instantiations)
- [2x reduction in core bundle size](#2x-reduction-in-core-bundle-size)
- [Introducing Zod Mini](#introducing-zod-mini)
- [Metadata](#metadata)
- [JSON Schema conversion](#json-schema-conversion)
- [Recursive objects](#recursive-objects)
- [File schemas](#file-schemas)
- [Internationalization](#internationalization)
- [Error pretty-printing](#error-pretty-printing)
- [Top-level string formats](#top-level-string-formats)
- [Template literal types](#template-literal-types)
- [Number formats](#number-formats)
- [Stringbool](#stringbool)
- [Simplified error customization](#simplified-error-customization)
- [Upgraded `z.discriminatedUnion()`](#upgraded-zdiscriminatedunion)
- [Multiple values in `z.literal()`](#multiple-values-in-zliteral)
- [Refinements live inside schemas](#refinements-live-inside-schemas)
- [An extensible foundation: `zod/v4/core`](#an-extensible-foundation-zodv4core)
...
For a complete list of breaking changes, refer to the [Migration guide](./migration-guide.md). This post focuses on new features and enhancements.
...
Refer to the [JSON Schema docs](./jsonSchema.md) for information on customizing the generated JSON Schema.
...
See the full list of supported locales in [Customizing errors](./customizing-errors.md#locales); this section is always updated with a list of supported languages as they become available.
...
Read the [template literal docs](./defining-schemas.md#template-literals) for more info.
...
Refer to the [`z.stringbool()` docs](./defining-schemas.md#stringbools) for more information.
...
For library authors, there is now a dedicated [Zod Core](./zod-core.md) guide that describes the best practices for building on top of Zod. It answers common questions about how to support Zod 3 & Zod 4 (including Mini) simultaneously.
