...
<Accordions>
  <Accordion title="Expected lengths and padding">
    ...
    -------------------- | ------- | --------------- | ------------- | | `"md5"`
    | 32 | 24 (22 + "==") | 22 | | `"sha1"` | 40 | 28 (27 + "=") | 27 | |
    `"sha256"` | 64 | 44 (43 + "=") | 43 | | `"sha384"` | 96 | 64 (no padding) |
    64 | | `"sha512"` | 128 | 88 (86 + "==") | 86 |
  </Accordion>
</Accordions>
...
> **New** — Introduced in Zod 4.1. Refer to the dedicated [Codecs](./codex.md) page for more information.
...
Refer to the dedicated [Codecs](./codex.md) page for more information. That page contains implementations for commonly needed codecs that you can copy into your project:

- [**`stringToNumber`**](./codex.md#stringtonumber)
- [**`stringToInt`**](./codex.md#stringtoint)
- [**`stringToBigInt`**](./codex.md#stringtobigint)
- [**`numberToBigInt`**](./codex.md#numbertobigint)
- [**`isoDatetimeToDate`**](./codex.md#isodatetimetodate)
- [**`epochSecondsToDate`**](./codex.md#epochsecondstodate)
- [**`epochMillisToDate`**](./codex.md#epochmillistodate)
- [**`json(schema)`**](./codex.md#jsonschema)
- [**`utf8ToBytes`**](./codex.md#utf8tobytes)
- [**`bytesToUtf8`**](./codex.md#bytestoutf8)
- [**`base64ToBytes`**](./codex.md#base64tobytes)
- [**`base64urlToBytes`**](./codex.md#base64urltobytes)
- [**`hexToBytes`**](./codex.md#hextobytes)
- [**`stringToURL`**](./codex.md#stringtourl)
- [**`stringToHttpURL`**](./codex.md#stringtohttpurl)
- [**`uriComponent`**](./codex.md#uricomponent)
- [**`stringbool`**](./codex.md#stringbool)
...
> **Note** — For bi-directional transforms, use [Codecs](./codex.md).
