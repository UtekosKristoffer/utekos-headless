...
> **File Organization**: This skill uses split structure. See `references/` for
> advanced patterns.

## 1. Overview

This skill provides GSAP (GreenSock Animation Platform) expertise for creating
smooth, professional animations in the JARVIS AI Assistant HUD.
...
2. **Performance Aware**: Use transforms/opacity for GPU acceleration, avoid
   layout thrashing
