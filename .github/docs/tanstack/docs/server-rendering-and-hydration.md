...
This also works with `getStaticProps` or even the older `getInitialProps` and
...
- In the framework loader function, create a
...
Avoid setting `gcTime` to `0` as it may result in a hydration error. This occurs
