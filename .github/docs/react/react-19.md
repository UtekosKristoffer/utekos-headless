...
- **Pending state:** Actions provide a pending state that starts at the
...
The `use` API can only be called in render, similar to hooks. Unlike hooks,
...
When React renders this component, it will see the `<title>`, `<link>`, and
