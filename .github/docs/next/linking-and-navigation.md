...
You can "debounce" the loading indicator by adding an initial animation delay
...
React mitigates this with Selective Hydration and you can further improve this
by:
