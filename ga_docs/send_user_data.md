...
it is possible to use the Google Analytics Measurement Protocol to send
user-provided data along with User-ID, which can be used to improve behavior and
...
> [!TIP] **Tip:** This sample shows how to send user data along with an event.
> You can also send a request that contains _only_ user data, without any
> events.
