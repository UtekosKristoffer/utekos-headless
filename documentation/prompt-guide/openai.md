...
This guide focuses on prompt changes that follow from those behavior changes.
...
Codex can implement the changes from this guide with the
...
[citation formatting guide](https://developers.openai.com/api/docs/guides/citation-formatting).
...
[example instructions](https://developers.openai.com/api/docs/guides/frontend-prompt)
for practical ways to steer UI quality. They cover product and user context,
design-system alignment, first-screen usability, familiar controls, expected
states, responsive behavior, and common generated-UI defaults to avoid, such as
generic heroes, nested cards, decorative gradients, visible instructional text,
and broken layouts.
