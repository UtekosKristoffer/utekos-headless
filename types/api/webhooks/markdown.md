# SHOPIFY PAYLOAD MIRRORED TYPESCRIPT DEFINITIONS

```typescript
// Path: types/integrations/shopify/webhooks/index.ts
...
```typescript
// Path: src/types/integrations/shopify/webhooks/OrderPaid.ts
// Mirroring the `OrderPaid` Webhook payload structure as defined by Shopify's API documentation
