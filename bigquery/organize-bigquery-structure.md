...
Folders as discussed here are part of the Google Cloud resource hierarchy. They shouldn't be confused with BigQuery folders, which you can use to organize code assets.
