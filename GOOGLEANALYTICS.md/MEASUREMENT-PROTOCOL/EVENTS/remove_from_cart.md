...
| `items`    | [`Array<Item>`](https://developers.google.com/analytics/devguides/collection/protocol/ga4/reference/events#remove_from_cart_item) | Yes      |               | The items for the event.                                                                                                                                                                                                                                                                                                                                                                    |
...
[Try this event in the Google Analytics Event Builder](https://ga-dev-tools.web.app/ga4/event-builder/?c=remove_from_cart)
